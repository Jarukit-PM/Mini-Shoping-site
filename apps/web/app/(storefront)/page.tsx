...
import { fetchProducts, formatPriceUSD } from "@/lib/api";
...
// Wrap the page body in Suspense so useSearchParams() doesn't break prerender.
        ...
        >
          ...
          <div className="mono muted" style={{ textAlign: "right" }}>
            <div>
              {loading
                ? "– / – items"
                : `${String(filtered.length).padStart(2, "0")} / ${products.length} items`}
            </div>
